...
//// CONFIGURED FOR COLOR OLED VERSION OF PCB
  ...
  .ports = {
    {
      .port = IOPORT1,  // PORTA
      .pads = {
        /* PTA0*/ PAL_MODE_ALTERNATIVE_3,   /* PTA1*/ PAL_MODE_ALTERNATIVE_3,   /* PTA2*/ PAL_MODE_ALTERNATIVE_3,
        /* PTA3*/ PAL_MODE_UNCONNECTED,     /* PTA4*/ PAL_MODE_UNCONNECTED,     /* PTA5*/ PAL_MODE_ALTERNATIVE_3, // CS0 -- might want to be GPIO?
        /* PTA6*/ PAL_MODE_ALTERNATIVE_3,   /* PTA7*/ PAL_MODE_ALTERNATIVE_3,   /* PTA8*/ PAL_MODE_ALTERNATIVE_2,
        /* PTA9*/ PAL_MODE_ALTERNATIVE_2,   /*PTA10*/ PAL_MODE_UNCONNECTED,     /*PTA11*/ PAL_MODE_UNCONNECTED,
        /*PTA12*/ PAL_MODE_INPUT,           /*PTA13*/ PAL_MODE_UNCONNECTED,    /*PTA14*/ PAL_MODE_UNCONNECTED,
    ...
    },
    {
      ...
      .pads = {
        ...
        /* PTB3*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTB4*/ PAL_MODE_OUTPUT_PUSHPULL,  /* PTB5*/ PAL_MODE_UNCONNECTED, // NMI
        ...
        /*PTB12*/ PAL_MODE_UNCONNECTED,     /*PTB13*/ PAL_MODE_OUTPUT_PUSHPULL,  /*PTB14*/ PAL_MODE_UNCONNECTED,
