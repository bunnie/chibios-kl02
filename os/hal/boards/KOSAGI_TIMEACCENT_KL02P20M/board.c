  ...
  .ports = {
    {
      ...
      .pads = {
        ...
        /* PTA3*/ PAL_MODE_UNCONNECTED,     /* PTA4*/ PAL_MODE_UNCONNECTED,     /* PTA5*/ PAL_MODE_OUTPUT_PUSHPULL, // CS0 -- might want to be GPIO?
        /* PTA6*/ PAL_MODE_OUTPUT_PUSHPULL,   /* PTA7*/ PAL_MODE_ALTERNATIVE_3,   /* PTA8*/ PAL_MODE_ALTERNATIVE_2,
        /* PTA9*/ PAL_MODE_ALTERNATIVE_2,   /*PTA10*/ PAL_MODE_UNCONNECTED,     /*PTA11*/ PAL_MODE_UNCONNECTED,
        /*PTA12*/ PAL_MODE_OUTPUT_PUSHPULL,    /*PTA13*/ PAL_MODE_UNCONNECTED,    /*PTA14*/ PAL_MODE_UNCONNECTED,
	...
	// set PTB1/2 to ALTERNATIVE_2 to swap UART TX/RX
        ...
        /* PTB3*/ PAL_MODE_INPUT, /* PTB4*/ PAL_MODE_INPUT,  /* PTB5*/ PAL_MODE_INPUT_PULLUP, // NMI
        ...
        /*PTB12*/ PAL_MODE_UNCONNECTED,     /*PTB13*/ PAL_MODE_INPUT,  /*PTB14*/ PAL_MODE_UNCONNECTED,
